...
* [`src/clj/bronze/`](src/clj/bronze/): CSS compilation source files (Clojure,
[Garden](https://github.com/noprompt/garden))
* [`src/cljs/bronze/`](src/cljs/bronze/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/bronze/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `bronze` project root directory
...
in the [`src/clj/bronze/`](src/clj/bronze/) directory. CSS files are compiled
...
The `debug?` variable in [`config.cljs`](src/cljs/bronze/config.cljs) defaults to `true` in
...
```clj
(ns bronze.example
  (:require [bronze.config :as config])
